...
def train(args):
    ...
    ''' 存 CD '''
    # fname = '/home/wuruihai/Detail-Preserved-Point-Cloud-Completion-via-SFA/data/rfa/TEST_scores/03001627/scores.txt'
    # fw = open(fname, 'w')
    # for model_id in score_dict.keys():
    #     print(model_id, score_dict[model_id])
    #     fw.write('%s\t%s\n' % (model_id, score_dict[model_id]))  # model_id \t CD \t EMD
